...
public final class Constants {
    ...
    public static final class Drivebase {
        ...
        public static final double FRONT_LEFT_X = Units.inchesToMeters(6.75);
        public static final double FRONT_LEFT_Y = Units.inchesToMeters(6.75);
        public static final double FRONT_RIGHT_X = Units.inchesToMeters(6.75);
        public static final double FRONT_RIGHT_Y = Units.inchesToMeters(-6.75);
        public static final double BACK_LEFT_X = Units.inchesToMeters(-6.75);
        public static final double BACK_LEFT_Y = Units.inchesToMeters(6.75);
        public static final double BACK_RIGHT_X = Units.inchesToMeters(-6.75);
        public static final double BACK_RIGHT_Y = Units.inchesToMeters(-6.75);
        ...
        public static final double MAX_SPEED = Units.feetToMeters(3.0); // meters per second
        public static final double MAX_ANGULAR_VELOCITY = -MAX_SPEED / Math.hypot(FRONT_LEFT_X, FRONT_LEFT_Y); // rad/s
        public static final double TELEOP_MAX_SPEED = Units.feetToMeters(3.5); // meters per second
    ...
    //Constants For Peanut 
    public static final class PeanutConstants{ 
        //Motors
