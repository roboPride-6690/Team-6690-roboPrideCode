...
public class autoBalance extends SequentialCommandGroup {
  public autoBalance(SwerveBase s_Swerve, double sx, double sy, double rx, double x, double y, double r) {
    TrajectoryConfig config =
        new TrajectoryConfig(
                Constants.Drivebase.AutoConstants.autoBalanceSpeed,
                Constants.Drivebase.AutoConstants.autoBalanceAcceleration)
